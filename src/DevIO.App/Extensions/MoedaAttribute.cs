...
namespace DevIO.App.Extensions
{
    public class MoedaAttribute : ValidationAttribute
    {
        ...
        {
            //Tratando a excption do decimal no side
            try
            {
    ...
    public class MoedaAttributeAdapter : AttributeAdapterBase<MoedaAttribute>
    {
        ...
        //Tratando a excption do decimal no client
    ...
    public class MoedaValidationAttributeAdapterProvieder : IValidationAttributeAdapterProvider
    {
