...
CREATE TABLE [Enderecos] (
    ...
    CONSTRAINT [FK_Enderecos_Fornecedor_FornecedorId] FOREIGN KEY ([FornecedorId]) REFERENCES [Fornecedor] ([Id]) ON DELETE NO ACTION
);
...
VALUES (N'20210512225910_Initial', N'3.1.14');
